...
// 🌸 เพิ่ม ① — ID ของ process ที่แยกออกไป
...
// 🌸 เพิ่ม ② — เรียก process ที่แยกออกไป (ครอบ try เพื่อไม่ให้ลากของเดิมพัง)
...
if (!prev) {
	return { success: true, built: 0, has_history: false, hn: hn || null, visit: null, cc: '', hpi: '', pe: null, dx: [], meds: [], other: [], plan: null, lab: [], xray: [], ...board }; // 🌸 เพิ่ม ③ — ...board ท้าย object
}
...
return {
	...
	// 🌸 เพิ่ม ④ — คีย์ของการ์ดแท็บ Lab / X-Ray (current_vn · lab_orders · xray_results · lab_trends)
	...board,
};
