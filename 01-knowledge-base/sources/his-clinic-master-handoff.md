...
source_file: "codex-backup/CLINIC_MASTER_HANDOFF.md (also mirrored at 02-his/handoff/CLINIC_MASTER_HANDOFF.md in this vault)"
source_type: note
...
Already exists in this vault at `Form-Builder/SDForm/sdform_module/clinic-master.json` (`modelName: formData`,
...
- Clinic Master and the LAB Workbench initiative are **architecturally similar in spirit**
  ...
  screen per category").
- **Retire the `lab-unit-master.json` file built earlier this session** (`Form-Builder/SDForm/sdform_module/lab-unit-master.json`,
