...
source_file: "03-source-materials/his-lab-bg-request-forms.md"
source_type: image
...
> Photos: `02-his/data/Biomolecular and Genetics/*.PNG` → transcription in
> `03-source-materials/his-lab-bg-request-forms.md`.
...
- ⚠ **Transcribed from photos.** Gene symbols, exon ranges, and `c.`/`p.` notation are OCR-risky.
  Do not build a master table from `03-source-materials/` — get the lab's electronic list.
