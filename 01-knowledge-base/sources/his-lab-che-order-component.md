...
source_file: "Form-Builder/SDForm/sdform_module/Lab_CHE_Order_Component.json"
source_type: note
...
- `lab_patient_header` appears **twice in the vault**: the older standalone
  `Form-Builder/SDForm/sdform_module/lab_order_form_step1.txt` (simple card) and the richer copy embedded here.
