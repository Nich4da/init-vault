...
- Artifact library: report JSON in `Form-Builder/SDForm/report_factory/`, JavaScript components/builders/tests
  in `Form-Builder/API/report_factory/`, and other templates/assets in `02-his/report_factory/`
