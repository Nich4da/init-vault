...
source_file: "raw/llm-wiki-idea.md"
source_type: article
source_date: unknown
author: unknown
sources: []
...
- Two navigation files: **index.md** (content catalog) and **log.md** (chronological journal).
...
- Open: at what scale do we outgrow `index.md` navigation and want a real search tool (qmd)? Revisit around ~100 sources.
