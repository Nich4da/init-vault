...
⚠ **`wiki/sources/his-lab-che-order-component.md` (created 2026-07-31) is now outdated.** It
documents `HIS/sdform_module/Lab_CHE_Order_Component.json` — a 3-field prototype (patient banner +
