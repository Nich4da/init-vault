---
name: report-factory
description: สร้างรายงาน (PDF/Excel/Word/LaTeX) ใน Report Factory ของ initCraft/SDForm — ประกอบ content widget + ผูก data จาก SQL Factory ด้วย {{field}} แล้ว render ผ่าน pdfmake. Use when user wants to build/design a report, สร้างรายงาน, ทำ report factory, report model, pdf report, ปรับหน้ากระดาษรายงาน, ตารางในรายงาน, หรือ export Excel/Word จากฟอร์ม. Renderer = SdReport.vue, model seed = sdform/report-model.json, report record เก็บเป็น record ในฟอร์ม report factory.
---
